 ...
 */
class liWidgetFormDoctrineJQueryAutocompleterMask extends liWidgetFormDoctrineJQueryAutocompleter
{
  /**
...
<script type="text/javascript">
  jQuery(document).ready(function() {
    ...
    .result(function(event, data) { 
      jQuery(input).val(data[0]); 
      $(this).closest('form').find('input[name="contact[phone_number]"], input[name="organism[phone_number]"]').mask(data[1]);
    })
    .change(function() {
