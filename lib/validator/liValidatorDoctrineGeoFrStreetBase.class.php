...
class liValidatorDoctrineGeoFrStreetBase extends sfValidatorString
{
  ...
  protected function doClean($value)
  {
    ...
    $city       = strtolower(str_replace(array('STE-', 'ST-'), array('SAINTE-', 'SAINT-'), GeoFrStreetBaseForm::sanitizeSearch($values['city'])));
    $postalcode = GeoFrStreetBaseForm::sanitizeSearch($values['postalcode']);
    $address    = strtolower(GeoFrStreetBaseForm::sanitizeSearch($value));
