      ...
      if ( !isset($this->json[$key]) )
      {
        ...
        case 'manifestations':
          ...
          $this->json[$product->ordering_key] = array(
            ...
            'image_kiosk_id'      => $product->Event->PictureKiosk->id,
            'image_kiosk_url'     => $product->Event->PictureKiosk->getUrl(array('absolute' => true)),
        ...
        case 'store':
          ...
          $this->json[$product->ordering_key] = array(
            ...
            'image_kiosk_id'      => $product->PictureKiosk->id,
            'image_kiosk_url'     => $product->PictureKiosk->getUrl(array('absolute' => true)),            
