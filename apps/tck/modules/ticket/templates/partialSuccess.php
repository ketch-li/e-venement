...
<div class="ui-widget-content ui-corner-all sf_admin_edit no-user-select" id="sf_admin_container">
  <div class="fg-toolbar ui-widget-header ui-corner-all">
    ...
    <p style="display: none;" id="global_transaction_id"><?php echo $transaction_id ?></p>
  </div>
  ...
  <script type="text/javascript">
    ...
    LI.directPrintTitle = <?php echo json_encode(__('e-venement will print the tickets directly on your printer')) ?>;
    LI.closePrintWindow = function() {
      setTimeout(function(){ window.close(); }, 2000);
    }
    LI.directPrintLogUrl = "<?php echo url_for('transaction/directPrintLog?id='.$transaction_id, true) ?>";
    ...
    $(document).ready(function(){
      ...
      $('form.print').submit(LI.closePrintWindow);
    });
  </script>
