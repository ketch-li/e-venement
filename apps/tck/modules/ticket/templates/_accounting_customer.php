<div id="customer">
  ...
  <p class="phonenumber inline-modifiable"><?php
    ...
    ? (count($transaction->Contact->Phonenumbers) > 0 ? $transaction->Contact->Phonenumbers[0]->number : '')
    : ($transaction->Professional->contact_number ? $transaction->Professional->contact_number : (count($transaction->Professional->Organism->Phonenumbers) > 0 ? $transaction->Professional->Organism->Phonenumbers[0]->number : ''))
  ?></p>
