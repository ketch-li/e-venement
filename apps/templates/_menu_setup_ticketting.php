...
***********************************************************************************/
?>
          <li class="menu-setup-ticketting"><a><?php echo __('Ticketing',array(),'menu') ?></a>
            <ul class="third">
              ...
              <li class="spaced"><?php echo cross_app_link_to(__('Selling options', null, 'menu'), 'tck', 'sellingOptions/index') ?></li>
              <?php endif ?>
            </ul>
          </li>
