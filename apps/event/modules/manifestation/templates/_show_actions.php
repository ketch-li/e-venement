<ul class="sf_admin_actions_form">
  ...
  <?php echo $helper->linkToExtraAction(array(  'params' => 'class= fg-button ui-state-default  ', 'app' => $museum ? 'museum' : 'event', 'action' => 'sell?id='.$manifestation->id, 'module' => 'manifestation',  'ui-icon' => 'cart', 'class_suffix' => 'sell',  'label' => 'Sell',)) ?>
  <?php endif ?>
