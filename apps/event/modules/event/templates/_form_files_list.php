...
<script type="text/javascript">
  var manifestation_file_url = "<?php echo url_for('event_files/add'); ?>";
  var manifestation_del_url = "<?php echo url_for('event_files/del'); ?>";
  var manifestation_id = <?php echo $event->id; ?>;
