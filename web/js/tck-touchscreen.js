...
$(document).ready(function(){
  ...
  // vCard & co
  $('#li_transaction_field_professional_id, #li_transaction_field_postalcode, #li_transaction_field_contact_id, #li_transaction_field_more').click(function(event, callback = null){
